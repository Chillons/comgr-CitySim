...
public final class StreetExample {
	...
	public static final int[][] strasse = { 
			{ STREET_NORTH_SOUTH, 	STREET_EAST_WEST,		CROSSING,	STREET_EAST_WEST, 	STREET_SOUTH_WEST }, 
			{ STREET_NORTH_SOUTH,	GRAS,		STREET_NORTH_SOUTH, 	GRAS, 				STREET_NORTH_SOUTH}, 
			{ STREET_NORTH_SOUTH,	GRAS,		STREET_NORTH_SOUTH, 	GRAS, 				STREET_NORTH_SOUTH }, 
			{ CROSSING, 			STREET_EAST_WEST,	CROSSING,  			STREET_EAST_WEST, 	CROSSING },
			{ STREET_NORTH_SOUTH,	GRAS,		STREET_NORTH_SOUTH, 	GRAS, 		 		STREET_NORTH_SOUTH },
			{ STREET_NORTH_EAST,	STREET_EAST_WEST,		STREET_NORTH_WEST, 	STREET_EAST_WEST, 				CROSSING} };
