...
public final class StreetExample {
	...
	public static final int[][] strasse = { 
			...
			{ STREET_NORTH_SOUTH,	GRAS,		STREET_NORTH_SOUTH, 	GRAS, 				STREET_NORTH_EAST, STREET_EAST_WEST, STREET_SOUTH_WEST}, 
			{ STREET_NORTH_SOUTH,	GRAS,		STREET_NORTH_SOUTH, 	GRAS, 				STREET_SOUTH_EAST, STREET_EAST_WEST, STREET_NORTH_WEST}, 
